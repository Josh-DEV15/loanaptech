...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Fetch current user
      const userResponse = await fetch("https://loanaptech-ten.vercel.app//api/auth/me", {
        credentials: "include"
      });
      ...
      const statsResponse = await fetch("https://loanaptech-ten.vercel.app//api/loans/dashboard/stats", {
        credentials: "include"
      });
      ...
      const loansResponse = await fetch("https://loanaptech-ten.vercel.app//api/loans/my-loans", {
        credentials: "include"
      });
